...
class JSONToDocument:
    """
    Convert JSON data into documents using a jq query.
    ...
    Example:
        ...
        output_dict = json_to_doc.run(sources=file_path, jq_data_schema=jq_data_schema,
                                      metadata_func=metadata_func, metadata={'dataset': 'nobel data set'},
    ...
    def run(
        ...
        """
        Convert JSON input to Document objects.
    ...
    def _single_doc(self, json_string: str) -> Iterator[Document]:
        ...
        try:
            ...
            return None
        try:
            calculated_metadata: Dict[str, Any] = {}
